...
void EventAction::DefinePrimaries(TLorentzVector* L_elec_init, TLorentzVector* L_elec_scat, TLorentzVector* L_phot1_final, TLorentzVector* L_phot2_final, TLorentzVector* L_prot_final, G4double vertex_x, G4double vertex_y, G4double vertex_z)
{
    ...
    TVector3 mom_final_phot_gen(fPx[2]+fPx[3], fPy[2]+fPy[3], fPz[2]+fPz[3]); // pi0 momenta for t and phi
    ...
    G4double tM_gen = 2*M_targ*(M_targ - fE[4]);
